...
* [前言：三个故事，三个刻度](chapters/preface.md)
* [序章：当效率提高100倍](chapters/ch00-when-efficiency-100x.md)

## Part 1：道 — 效率觉醒

* [Ch1：忙 ≠ 产出 — 效率的定义需要重写](chapters/part1/ch01-busy-not-productive.md)
* [Ch2：AI不是对手，是队友 — 焦虑是最大的效率杀手](chapters/part1/ch02-ai-is-teammate.md)
...
* [Ch7：环境设计 — 进入心流的系统方法](chapters/part2/ch07-flow-state.md)
* [Ch8：决策外包 — 重复决策变规则](chapters/part2/ch08-decision-offload.md)
* [Ch9：复盘飞轮 — 做→复盘→优化的最小闭环](chapters/part2/ch09-review-flywheel.md)
...
* [附录A：AI工具速查表](appendix/tools.md)
* [附录B：每章小练习汇总](appendix/exercises.md)
